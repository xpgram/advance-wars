...
export class VirtualGamepad {
    ...
    button = {
        ...
        leftBumper: new Button(new ButtonMap(DefaultControllerMap.leftBumper, null, DefaultKeyboardMap.D, null)),
        rightBumper: new Button(new ButtonMap(DefaultControllerMap.rightBumper, null, DefaultKeyboardMap.Ctrl, null)),
        leftTrigger: new Button(new ButtonMap(DefaultControllerMap.leftTrigger, null, DefaultKeyboardMap.F, null)),
