...
Copied from Pixi so that I may learn from them.
I'm writing an adaptation of sorts.
I'm mostly concerned with how kerning and such is handled, though.
 ...
 * @memberof PIXI
 */
export class TWBitmapText extends Container
{
    ...
    constructor(text: string, style: Partial<IBitmapTextStyle> = {})
    {
        ...
        this._fontSize = fontSize || PIXI.BitmapFont.available[fontName].size;
        this.text = text;
    ...
    {
        const data = PIXI.BitmapFont.available[this._fontName];
    ...
    _render(renderer: Renderer): void
    {
        ...
        // Update the uniform
        const { distanceFieldRange, distanceFieldType, size } = PIXI.BitmapFont.available[this._fontName];
    ...
    {
        if (!PIXI.BitmapFont.available[value])
        {
