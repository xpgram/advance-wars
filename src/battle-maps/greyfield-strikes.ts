...
export const data = {
  ...
  "owners": [
    {"location": {"x": 9, "y": 1}, "player": 2},
    {"location": {"x": 9, "y": 2}, "player": 2},
    {"location": {"x": 7, "y": 3}, "player": 2},
    {"location": {"x":11, "y": 0}, "player": 2},
    {"location": {"x":12, "y": 2}, "player": 2},
    {"location": {"x":15, "y": 0}, "player": 2},
    {"location": {"x":19, "y": 0}, "player": 2},
    {"location": {"x":18, "y": 4}, "player": 2},
    {"location": {"x":19, "y": 5}, "player": 2},

    {"location": {"x":19, "y":10}, "player": 1},
    {"location": {"x":18, "y":10}, "player": 1},
    {"location": {"x":17, "y":11}, "player": 1},
    {"location": {"x":19, "y":11}, "player": 1},
    {"location": {"x":17, "y":12}, "player": 1},
    {"location": {"x":18, "y":12}, "player": 1},
    {"location": {"x":19, "y":12}, "player": 1},
    {"location": {"x":15, "y":13}, "player": 1},
    {"location": {"x":16, "y":13}, "player": 1},
    {"location": {"x":18, "y":13}, "player": 1},
    {"location": {"x":19, "y":13}, "player": 1},
  ],
  "predeploy": [
    {"location": {"x": 1, "y": 1}, "serial": car, "player": 2},
    {"location": {"x": 4, "y": 1}, "serial": gnb, "player": 2},
    {"location": {"x": 6, "y": 1}, "serial": lnd, "player": 2},
    {"location": {"x": 8, "y": 0}, "serial": inf, "player": 2},
    {"location": {"x":12, "y": 1}, "serial": tnk, "player": 2},
    {"location": {"x":17, "y": 0}, "serial": mdt, "player": 2},
    {"location": {"x":19, "y": 0}, "serial": msl, "player": 2},
    {"location": {"x": 7, "y": 2}, "serial": btl, "player": 2},
    {"location": {"x":19, "y": 2}, "serial": aai, "player": 2},
    {"location": {"x": 7, "y": 3}, "serial": mch, "player": 2},
    {"location": {"x":10, "y": 3}, "serial": art, "player": 2},
    {"location": {"x":14, "y": 3}, "serial": gnb, "player": 2},
    {"location": {"x":18, "y": 4}, "serial": msl, "player": 2},
    {"location": {"x": 3, "y":11}, "serial": btl, "player": 2},

    {"location": {"x":18, "y":13}, "serial": rig, "player": 1},
    {"location": {"x":16, "y":13}, "serial": inf, "player": 1},
    {"location": {"x":14, "y":13}, "serial": gnb, "player": 1},
    {"location": {"x":15, "y":12}, "serial": lnd, "player": 1},
    {"location": {"x":17, "y":12}, "serial": inf, "player": 1},
    {"location": {"x":15, "y":11}, "serial": car, "player": 1},
    {"location": {"x":17, "y":10}, "serial": gnb, "player": 1},
    {"location": {"x":16, "y": 9}, "serial": cru, "player": 1},
    {"location": {"x":18, "y": 9}, "serial": btl, "player": 1},
    {"location": {"x":17, "y": 8}, "serial": sub, "player": 1},

    {"location": {"x": 4, "y": 8}, "serial": gnb, "player": 3},
    {"location": {"x": 6, "y":10}, "serial": gnb, "player": 3},
    {"location": {"x":12, "y": 6}, "serial": rig, "player": 3},
  ]
}