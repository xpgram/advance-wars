...
export const data = {
  ...
  "owners": [
    {"location": {"x":27, "y": 2}, "player": 2},
    {"location": {"x":18, "y": 3}, "player": 2},
    {"location": {"x":23, "y": 3}, "player": 2},
    {"location": {"x":24, "y": 4}, "player": 2},
    {"location": {"x":26, "y": 4}, "player": 2},
    {"location": {"x":29, "y": 4}, "player": 2},
    {"location": {"x":21, "y": 5}, "player": 2},
    {"location": {"x":22, "y": 5}, "player": 2},
    {"location": {"x":25, "y": 5}, "player": 2},
    {"location": {"x":26, "y": 5}, "player": 2},
    {"location": {"x":27, "y": 5}, "player": 2},
    {"location": {"x":26, "y": 6}, "player": 2},
    {"location": {"x":25, "y": 7}, "player": 2},
    {"location": {"x":27, "y": 7}, "player": 2},

    {"location": {"x": 3, "y": 4}, "player": 1},
    {"location": {"x": 3, "y": 6}, "player": 1},
    {"location": {"x":14, "y":12}, "player": 1},
    {"location": {"x":16, "y":13}, "player": 1},
    {"location": {"x":17, "y":14}, "player": 1},
    {"location": {"x":19, "y":14}, "player": 1},
    {"location": {"x":18, "y":15}, "player": 1},
    {"location": {"x":20, "y":15}, "player": 1},
    {"location": {"x":19, "y":16}, "player": 1},
    {"location": {"x":26, "y":18}, "player": 1},
  ],
  "predeploy": [
    {"location": {"x":18, "y": 3}, "serial": rck, "player": 2},
    {"location": {"x":19, "y": 4}, "serial": mdt, "player": 2},

    {"location": {"x":19, "y":15}, "serial": msl, "player": 1},
    {"location": {"x":15, "y":13}, "serial": tnk, "player": 1},
  ]
}