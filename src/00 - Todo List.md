...
- [x] CO-unit badge update
  - [ ] Visual harmony
    - I like the folded flag look. Kind of a lot, actually.
      But what about adding the medal colors to the lock-icon normally used?
      Worth trying, anyway. Then you wouldn't need two different cargo icons that alternate between each other; just seems redundant.
