 ...
 * @version 0.1.0
 */
export abstract class SceneTransitionEffect {
  ...
  protected overlayer!: PIXI.Container;
  /** The scene layer for the scene being transitioned from. */
  protected lastScene!: PIXI.Container;
  /** The scene layer for the scene being transitioned to. */
  protected nextScene!: PIXI.Container;


  /** Must be called before any other execution step. Called by system. */
  init(overlayer: PIXI.Container, lastScene: PIXI.Container, nextScene: PIXI.Container) {
